...
| config_version | Specifies the version of your OIL configuration. It will be stored with the consent cookie to track of which explicit configuration version consent was granted for.| None
