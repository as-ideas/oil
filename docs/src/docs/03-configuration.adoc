...
| locale* | The locale version that should be used. The locale defines the standard labels for all legal texts and buttons. <<language-configuration,See available locale parameters>> | enEN_01
