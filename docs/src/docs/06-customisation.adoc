...
|label_cpc_purpose_xx_features| A list of texts describing the features of purpose with id `xx` (e.g. `01`). Only used in tab-based CPC. If undefined nothing is shown.| ["Storage of information.", "Acces to information"]
