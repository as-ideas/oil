...
|label_later| We're using cookies, please confirm.
...
|label_nocookie_text| Please allow cookies!
|====
...
|label_later_start| We're using cookies, read
|label_later_end| and please confirm.
