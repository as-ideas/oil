...
----
* Add OIL and the CMP-stub to your website, with a tag manager like <<adding-oil-js-to-your-site-via-tealium-recommended,tealium>> or <<adding-oil-js-to-your-site-via-direct-integration,directly>> as a tag, for exampel:
