...
[source, javascript]
----
<script type="text/javascript" src="https://http://oil.asideas.de/release/oil.1.0.7.min.js"></script>
----
...
| ga_tracking | A nummeric value to enable/disable Google Anayltics event tracking, where 0=disabled, 1=enabled for YES clicks, 2=enabled for all clicks including NO.
...
| ga_tracker_name | If you use a custom tracker name, like in Google Tag Manager, configure it here. | None | No
