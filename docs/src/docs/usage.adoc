...
| oil_has_optedin| On every page reload, when the user has opted_in previously
| oil_has_optedlater| On every page reload, when the user has opted_later previously
| oil_has_optedignore| On every page reload, when the user has opted_ignore previously
| oil_loaded| When the script is loaded initially
|====
