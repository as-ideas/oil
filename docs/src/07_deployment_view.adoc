...
Your website which is using OIL should support CORS from the hub domain and include it via HTTPS. The OIL hub origin needs to be included in the CORS-origin!
