import { sendEventToHostSite, OilVersion } from './scripts/headless/headless_utils.js';
import { registerOptOutListener } from './scripts/headless/headless_optout.js';
import { logInfo, logPreviewInfo } from './scripts/headless/headless_log.js';
import { checkOptIn, hasOptedIgnore, hasOptedLater } from './scripts/headless/headless_optin.js';
import { resetConfiguration, isPreviewMode } from './scripts/headless/headless_config.js';
import {
...
} from './scripts/headless/headless_constants.js';
import {
  isPreviewCookieSet,
  setPreviewCookie,
  setVerboseCookie,
  ...
  getRawSoiCookie
} from './scripts/headless/headless_cookies.js';
...
export function initOilLayer() {
  ...
  if (!isPreviewMode() || isPreviewCookieSet()) {
    ...
    if (!isBrowserCookieEnabled()) {
      ...
      // TODO load core and display no cookie warning
