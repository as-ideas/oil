export const OIL_LABELS = {
  ...
  ATTR_LABEL_POI_GROUP_LIST_HEADING: 'attr_label_poi_group_list_heading',
  ATTR_LABEL_POI_GROUP_LIST_TEXT: 'attr_label_poi_group_list_text',
