    ...
    return `
              <div class="${CSSPrefix}oil-l-row">
                ...
                <div class="${CSSPrefix}slider-desc">
                  <div id="slider-essential-title" class="${CSSPrefix}slider-inactive ">
                  ...
                  <div id="slider-functional-title" class="${CSSPrefix}slider-inactive">
                  ...
                  <div id="slider-advertising-title" class="${CSSPrefix}slider-inactive">
